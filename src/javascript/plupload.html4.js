...
define(['libs/plupload', 'du/core', 'dudu'], function (plupload, Du, Dudu) {

    (function (window, document) {

        if (!Du.enableXDomain(Dudu.config.rootDomain)) {
            Du.log('plupload.html4: failed to init subdomain communication. Module is not loaded.');
            ...
            init: function (uploader, callback) {
                uploader.bind("Init", function (up) {
                    ...
                    function createIframe() {
                        ...
                        temp.innerHTML = '<iframe id="' + frameId + '" name="' + frameId + '" src="' + url + ':&quot;&quot;" style="display:none"></iframe>';
                        ...
                        plupload.addEvent(iframe, 'load', function (e) {
                            ...
                            try {
                                result = n.contentWindow.uploadResult;
                            } catch (ex) {
